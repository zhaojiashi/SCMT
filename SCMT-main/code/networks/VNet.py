...
class SCMT3d(nn.Module):
    def __init__(self, n_channels=3, n_classes=2, n_filters=16, normalization='none', has_dropout=False, has_residual=False):
        super(MCNet3d_v2, self).__init__()#调用父类 nn.Module 的初始化函数
...
if __name__ == '__main__':
    ...
    model = MCNet3d_v1(n_channels=1, n_classes=2, normalization='batchnorm', has_dropout=False)
